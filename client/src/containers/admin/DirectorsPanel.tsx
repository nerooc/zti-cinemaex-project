...
import DeleteDirectorPanel from './DeleteDirectorPanel';
...
const DirectorsPanel = () => {
  ...
  const { name, surname, description, image } = director;
  ...
  const handleSubmit = async (
    ...
    try {
      const { data } = await axios.post('/directors/add', body, {
        headers: {
